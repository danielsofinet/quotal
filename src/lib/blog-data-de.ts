...
export const blogPostsDe: BlogPost[] = [
  {
    ...
    title: "Lieferantenangebote vergleichen: Der vollständige Leitfaden für 2026",
    description: "Erfahren Sie, wie Sie Lieferantenangebote effektiv vergleichen — mit Schritt-für-Schritt-Anleitung, 10-Punkte-Checkliste und Tipps zur Bewertung von Angeboten.",
...
Hier kann ein Tool wie [Quotal](https://quotal.app) erheblich Zeit sparen. Statt für jeden Einkauf Ihre Vergleichstabelle neu aufzubauen, laden Sie Angebote hoch, und die Plattform übernimmt Normalisierung, Datenextraktion und den Seite-an-Seite-Vergleich automatisch — mit einer Preishistorie, die jeden künftigen Vergleich schneller und fundierter macht.
...
- [7 versteckte Gebühren in Ihren Lieferantenangeboten](/blog/hidden-fees-vendor-quotes)
- [Kostenlose Vorlage für den Angebotsvergleich](/blog/vendor-quote-comparison-template)
- [Preishistorie nutzen: So verhandeln Sie bessere Lieferantenkonditionen](/blog/pricing-history-supplier-negotiation)`,
  },
  {
    slug: "hidden-fees-vendor-quotes",
    title: "7 versteckte Gebühren in Lieferantenangeboten (und wie Sie sie erkennen)",
    description: "Entdecken Sie die 7 häufigsten versteckten Kosten in Lieferantenangeboten und lernen Sie, diese zu erkennen, bevor sie Ihr Budget sprengen. Inklusive Prüf-Checkliste.",
...
**Weiterführende Artikel:**
- [Lieferantenangebote vergleichen: Der vollständige Leitfaden](/blog/how-to-compare-supplier-quotes)
- [Kostenlose Vorlage für den Angebotsvergleich](/blog/vendor-quote-comparison-template)
- [Bauausschreibungen vergleichen: So bewerten Sie Nachunternehmerangebote](/blog/construction-bid-comparison)`,
  },
  {
    slug: "vendor-quote-comparison-template",
    title: "Kostenlose Vorlage für den Angebotsvergleich (Excel & Google Sheets)",
    description: "Laden Sie unsere kostenlose Vorlage für den Angebotsvergleich herunter — für Excel und Google Sheets. Mit gewichteter Bewertung, TCO-Berechnung und Schritt-für-Schritt-Anleitung.",
    readingTime: "9 Min. Lesezeit",
    date: "2026-03-09",
...
**Formel für Google Sheets:**
Wählen Sie die „Gültig bis"-Zellen und wenden Sie eine benutzerdefinierte Regel an: \`=B5 < TODAY()\` mit roter Füllung.
...
Tools wie [Quotal](https://quotal.app) automatisieren die mühsamen Teile — Datenextraktion aus Angebotsdokumenten, Positionsnormalisierung und Aufbau der Vergleichsmatrix — und überlassen Ihnen trotzdem Ihre eigene Bewertung und Gewichtung für die finale Entscheidung. Es ist der Unterschied zwischen jedes Mal eine Tabelle neu aufzubauen und einem System, das aus jedem Vergleich lernt.
...
- [Preishistorie nutzen: So verhandeln Sie bessere Lieferantenkonditionen](/blog/pricing-history-supplier-negotiation)`,
  },
  {
    ...
    title: "Bauausschreibungen vergleichen: So bewerten Sie Nachunternehmerangebote",
    description: "Meistern Sie den Vergleich von Bauausschreibungen mit diesem Praxisleitfaden. Lernen Sie Angebotsauswertung, Leistungsabgleich und typische Fallen bei Nachunternehmerangeboten.",
...
- [Kostenlose Vorlage für den Angebotsvergleich](/blog/vendor-quote-comparison-template)`,
  },
  {
    ...
    title: "Preishistorie nutzen: So verhandeln Sie bessere Lieferantenkonditionen",
    description: "Erfahren Sie, wie Sie Preisentwicklungen bei Lieferanten systematisch erfassen und mit Daten bessere Konditionen verhandeln. Mit realen Szenarien und Strategien für den Mittelstand.",
    readingTime: "9 Min. Lesezeit",
    date: "2026-03-09",
...
Wenn Sie den Prozess beschleunigen wollen, bauen Tools wie [Quotal](https://quotal.app) bei jedem Angebotsvergleich automatisch eine Preishistorie auf — ganz ohne manuelle Dateneingabe. Jeder Vergleich wird zu einem Datenpunkt in Ihrer Lieferanten-Preisdatenbank, sodass sich die Erkenntnisse ohne Zusatzaufwand potenzieren.
